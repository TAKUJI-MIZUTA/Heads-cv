...
//   ﾌｧｲﾙ概要：圧力容器強度計算書(ATU22)  作成モジュール
//　 作 成 者：N.Uchida
//　 作 成 日：2002.06.06
//　 更 新 日：2002.09.20
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
// 日本語関数名： 圧力容器強度計算書(ATU22)　作成
// 概  要      ：
// 引  数      ： なし
// 戻り値      ： 処理結果 [true:正常 false:異常]
// 備  考      ： なし
//---------------------------------------------------------------------------
bool __fastcall Atu22(void)
{
   ...
   i_RecNo = 1118;
   s_Text = G_HEADS_DATA[i_RecNo].TrimRight();
   Excel_Cell_DataSet(37, 16, s_Text);
   Excel_Cell_DataSet(39, 28, s_Text);
   ...
   i_RecNo = 1117;
   s_Text = G_HEADS_DATA[i_RecNo].TrimRight();
   Excel_Cell_DataSet(36, 24, s_Text);
   ...
   Excel_Cell_DataSet(41, 14, s_Text);
   //********************
   ...
   //2003.09.10 UNﾈｼﾞ訂正
   //Excel_Cell_DataSet(41, 23, s_Text);
