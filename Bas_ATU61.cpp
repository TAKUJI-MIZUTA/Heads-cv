...
//   ﾌｧｲﾙ概要：圧力容器強度計算書(ATU61)  作成モジュール
//　 作 成 者：N.Uchida
//　 作 成 日：2002.06.06
//　 更 新 日：2002.09.20
//---------------------------------------------------------------------------
...
bool __fastcall Atu61(void)
{
   ...
   //***  ｼｰﾄの指定
   //*******************
   s_BN = G_HEADS_DATA[1020].ToIntDef(0);  // ﾎﾞﾙﾄ数取得

   switch (s_BN) {
      case 2 :
         s_SheetName = "強度計算書61-2";
         break;
      case 3 :
         s_SheetName = "強度計算書61-3";
         break;
      case 4 :
         s_SheetName = "強度計算書61-4";
         break;
      case 5 :
         s_SheetName = "強度計算書61-5";
         break;
      case 6 :
         s_SheetName = "強度計算書61-6";
         break;
      case 7 :
         s_SheetName = "強度計算書61-7";
         break;
      default :
         G_ErrLog_Text = "BN                    不正な値『" + s_Text + "』 です。";
   ...
   i_RecNo = 1113;
   s_Text = G_HEADS_DATA[i_RecNo].TrimRight();
   Excel_Cell_DataSet(24,  6, s_Text);
   ...
   //***************************
   // 『A020』
   if (s_SheetName != "強度計算書61-2"){
      i_RecNo = 1114;
      s_Text = G_HEADS_DATA[i_RecNo].TrimRight();
      Excel_Cell_DataSet(25,  6, s_Text);
   ...
   G_Log_Text = "大基案第            RecNo:" + FormatFloat("0000",i_RecNo) + "『" + s_Text + "』をセット。";
   Write_Log(G_Log_Text);
   ...
   G_Log_Text = "大基案号            RecNo:" + FormatFloat("0000",i_RecNo) + "『" + s_Text + "』をセット。";
   Write_Log(G_Log_Text);
